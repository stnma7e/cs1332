...
public class SortingStudentTests {
    ...
    public void testQuickSort() {
        Integer[] unsortedArray = new Integer[] {86, 6, 31, 72, 38, 43, 93, 69};
        // Integer[] sortedArray = new Integer[] {6, 31, 38, 43, 69, 72, 86, 93};
        Sorting.quickSort(tas, comp, new Random(0x600dc0de));
        /*
        Sorting.quickSort(unsortedArray, new ComparatorPlus<Integer>() {
            @Override
